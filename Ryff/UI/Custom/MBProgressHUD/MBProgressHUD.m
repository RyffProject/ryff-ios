...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.color = [UIColor colorWithWhite:0.25 alpha:0.95f];
		self.labelFont = [UIFont fontWithName:kBoldFont size:kLabelFontSize];
		self.labelColor = [UIColor whiteColor];
		self.detailsLabelFont = [UIFont fontWithName:kRegularFont size:kDetailsLabelFontSize];
